class GameView{
    ...
    render(bola: Bola, jogadorEsquerda: Jogador, jogadorDireita: Jogador): void{
        this.context.clearRect( 0, 0, this.canvas.width, this.canvas.height )
        this.context.fillStyle = 'white'
        this.context.fillRect( bola.getX(), bola.getY(), bola.getLargura(), bola.getAltura() )
        this.context.fillRect(  jogadorEsquerda.getX(), 
                                jogadorEsquerda.getY(), 
                                jogadorEsquerda.getLargura(),
                                jogadorEsquerda.getAltura()
        )
                                
        this.context.fillRect( jogadorDireita.getX(), 
                        jogadorDireita.getY(), 
                        jogadorDireita.getLargura(),
                        jogadorDireita.getAltura() )
